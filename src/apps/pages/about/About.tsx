    ...
    <Container>
      <div>
        ...
        <p className="leading-1">
          ...
          development, actively seeking opportunities in the UK tech industry.
          With over a year of professional experience building production-ready
          applications using React, TypeScript, and modern web technologies, I'm
          passionate about writing clean, maintainable code and solving complex
          technical challenges.
        </p>
        <p className="leading-1 mt-2">
          Throughout my internship and work experience, I've contributed to
          real-world projects including recruitment platforms and time
          management systems. I specialise in frontend development whilst
          maintaining a strong understanding of backend technologies, RESTful
          APIs, and database management. I'm particularly interested in working
          with companies that value innovation, continuous learning, and best
          coding practices.
        </p>
        <p className="leading-1 mt-2">
          Beyond coding, I'm an avid reader who aims to finish at least one book
          per month to broaden my perspectives. I also enjoy trekking and
          photography, which you can view on my{" "}
          <a
